...
const PRODUCT = {
    ...
    thumbnails: ['/images/sh-1.png', '/images/sh-2.png', '/images/image 9.png', '/images/sh-1.png', '/images/sh-2.png', '/images/image 9.png', '/images/sh-1.png', '/images/sh-2.png', '/images/image 9.png'],
    title: 'Nike Air Max Plus',
    category: "Men's Shoes",
    price: '2,590 EGP',
    colors: ['#2d3e40', '#c84c5e', '#4dd9ac'],
